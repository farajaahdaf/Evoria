        ...
        <div class="space-y-3">
            ...
            <div class="space-y-2">
                ...
                <template x-if="step === 2">
                    <h2 class="text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl">Lengkapi portofolio dan proposal event Anda.</h2>
                </template>
                <p class="text-sm leading-6 text-slate-500">
                    ...
                    <template x-if="step === 2">
                        <span>Dokumen ini akan membantu admin memverifikasi keaslian dan kualitas penyelenggaraan event Anda.</span>
                    </template>
                </p>
            </div>
                ...
                <div class="space-y-4">
                    <div class="rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/50 p-6 transition hover:border-primary/50">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <label for="portfolio" class="text-sm font-bold text-slate-900">Portofolio Perusahaan/Komunitas</label>
                            <p class="mt-1 text-xs text-slate-500">PDF atau Gambar (Maks. 5MB). Lampirkan rekam jejak event sebelumnya.</p>
                            <input id="portfolio" name="portfolio" type="file" accept=".pdf,image/*" class="mt-4 block w-full text-xs text-slate-500 file:mr-4 file:rounded-full file:border-0 file:bg-blue-50 file:px-4 file:py-2 file:text-xs file:font-semibold file:text-primary hover:file:bg-blue-100">
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/50 p-6 transition hover:border-primary/50">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <label for="proposal" class="text-sm font-bold text-slate-900">Proposal Event Mendatang</label>
                            <p class="mt-1 text-xs text-slate-500">Hanya PDF (Maks. 10MB). Sertakan rencana detail event Anda.</p>
                            <input id="proposal" name="proposal" type="file" accept=".pdf" class="mt-4 block w-full text-xs text-slate-500 file:mr-4 file:rounded-full file:border-0 file:bg-emerald-50 file:px-4 file:py-2 file:text-xs file:font-semibold file:text-emerald-700 hover:file:bg-emerald-100">
                        </div>
                    </div>
                </div>
