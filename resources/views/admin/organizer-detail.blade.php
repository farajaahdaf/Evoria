                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        <form action="{{ route('admin.organizers.verify', $organizer->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="inline-flex items-center px-8 py-4 bg-[#10367d] text-white rounded-xl font-bold hover:bg-[#0c2a61] transition shadow-lg shadow-indigo-100 transform hover:-translate-y-0.5">
